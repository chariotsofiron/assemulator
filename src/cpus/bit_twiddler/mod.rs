...
impl Cpu for BitTwiddler {
    ...
    fn parse_tokens(
        ...
        let inst: u16 = match *tokens {
            ...
            [Inst(Shl), Reg(ra)] => ra.to_a() | ra.to_b() | 0b10000,
            [Inst(Shlc), Reg(ra)] => ra.to_a() | ra.to_b() | 0b10001,
            [Inst(Shlx), Reg(ra)] => ra.to_a() | ra.to_b() | 0b10010,
            [Inst(Shlb), Reg(ra)] => ra.to_a() | ra.to_b() | 0b10011,
            [Inst(Shr), Reg(ra)] => ra.to_a() | ra.to_b() | 0b10100,
            [Inst(Shrc), Reg(ra)] => ra.to_a() | ra.to_b() | 0b10101,
            [Inst(Shrx), Reg(ra)] => ra.to_a() | ra.to_b() | 0b10110,
            [Inst(Shrb), Reg(ra)] => ra.to_a() | ra.to_b() | 0b10111,
